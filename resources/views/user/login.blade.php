...
<div class="container">
    <div class="row">
        <form role="form" class="signin" method="POST" action="/user/login{{ $returnUrl ? '?return_url='.rawurlencode($returnUrl) : '' }}" id="loginPageForm">
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <div class="form-group">
                        <input type="text" maxlength="100" required name="username" class="form-control input-lg" id="username" placeholder="Username or Email" value="{!! $username ?? '' !!}">
                    </div>
                </div>
            </div>
            <div class="row">
